...
<div class="content-container">
    <h1 class="page-title"><i class="fas fa-users icon"></i> User Management</h1>
    ...
    <table class="user-table">
        ...
        <tr>
            <td><%= user[0] %></td>
            <td><%= user[1].replaceAll(".", "*") %></td>
            <td><%= user[2] %></td>
            <td><%= user.length > 3 ? user[3] : "N/A" %></td>
    ...
    <div class="user-cards">
        <% for (String[] user : users) { %>
        <div class="user-card">
            <div class="card-header"><%= user[0] %></div>
            <div class="card-info"><span>Email:</span> <%= user[2] %></div>
            <div class="card-info"><span>Phone:</span> <%= user.length > 3 ? user[3] : "N/A" %></div>
            <div class="card-info"><span>Role:</span> <%= user.length > 4 ? user[4] : "User" %></div>
